...
const IndexPage = () => {
  ...
  return (
    <div className="page">
      ...
      <div className="swheader subheader2"><StaticImage className="swimage" src={'../images/plant.png'} alt={"selected studies"} placeholder={'none'} width={45} />Doodlings<div className="lines" /></div>
