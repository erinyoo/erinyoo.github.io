...
const DBSACardNarrow: FC = () => {
    return (
        <motion.div sx={{
            position: 'absolute', marginRight: 'auto', marginLeft: 'auto', left: 0, right: 0, top: 650,
            ...
            <Card sx={{ padding: 4 }}>
                <Flex dir={'row'}>
                    <Box sx={{ flexGrow: 1 }} >
                        <Flex sx={{ flexDirection: 'column', justifyContent: 'space-between', height: 150, paddingLeft: 4, color: '#007cd4' }}>
                            ...
                            <Box sx={{ fontSize: 3, paddingTop: 1 }}>
