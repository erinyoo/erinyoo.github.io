        ...
        <Box sx={{ width: '80%', position: 'absolute', left: 0, right: 0, marginLeft: 'auto', marginRight: 'auto', paddingBottom: 16 }}>
            ...
            <Flex sx={{ width: '100%', flexDirection: 'column', borderRadius: 8, background: 'linear-gradient(150deg, rgba(155,212,247,0.26514355742296913) 54%, rgba(255,254,252,0.30155812324929976) 95%)', boxShadow: 'rgba(149, 157, 165, 0.1) 0px 8px 24px', px: 7, py: 6 }}>
                ...
                <Link sx={{ textDecoration: 'none' }} to={'https://www.figma.com/proto/SZhOtgWIkeM7wUtplERzHE/DBSA-Prototype?page-id=3%3A2&node-id=27%3A3309&viewport=4485%2C-948%2C0.5&scaling=scale-down&starting-point-node-id=70%3A3524'}>
                    <Box sx={{ marginTop: 5, color: '#007cd4', padding: 3, borderRadius: 9, border: '2px solid #007cd4', width: '60%', textAlign: 'center', fontWeight: 'bold' }}>See the final prototype</Box>
                </Link>
            </Flex>
            ...
            <Flex sx={{ width: '100%', flexDirection: 'column', paddingTop: 7 }}>
                ...
                <Box sx={{ width: '100%' }}><StaticImage src={"../../images/dbsauserflow.png"} alt={"lofi"} placeholder={'none'} width={3500} /></Box>
            </Flex>

            <Flex sx={{ width: '100%', flexDirection: 'column', paddingTop: 7 }}>
                <Title title={'Mapping a jumping off point'} />
                <Box sx={{ width: '100%' }}><StaticImage src={"../../images/componentslibrary.png"} alt={"components"} placeholder={'none'} width={3500} /></Box>
                <Text sx={{ paddingTop: 2 }}>
                ...
                <Box sx={{ width: '100%' }}><StaticImage src={"../../images/lofi.png"} placeholder={'none'} alt={"lofi"} /></Box>
            </Flex>
            ...
            <Flex sx={{ width: '100%', flexDirection: 'column', paddingTop: 7 }}>
                ...
                <Box sx={{ width: '100%' }}><StaticImage src={"../../images/onboarding.png"} placeholder={'none'} alt={"onboarding"} /></Box>
                <Flex sx={{ width: '100%', flexDirection: 'column', paddingTop: 7 }}>
                ...
                <Box sx={{ width: '100%' }}><StaticImage src={"../../images/daily.png"} placeholder={'none'} alt={"daily"} /></Box>
                <Flex sx={{ width: '100%', flexDirection: 'column', paddingTop: 7 }}>
                ...
                <Box sx={{ width: '100%' }}><StaticImage src={"../../images/support.png"} alt={"support"} placeholder={'none'} /></Box>
                ...
                <Box sx={{ width: '100%', paddingTop: 5, paddingBottom: 3 }}><StaticImage src={"../../images/pandas.png"} alt={"lofi"} placeholder={'none'} width={3500} /></Box>
            </Flex>
...
export default DBSAContentNarrow
